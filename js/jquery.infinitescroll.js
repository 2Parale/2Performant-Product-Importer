...
;(function($){
  ...
  $.fn.infinitescroll = function(options,callback){
    ...
    // console log wrapper.
    function debug(){	
      if (opts.debug) { window.console && console.log.apply(console,arguments)}
    }
    ...
    function kickOffAjax(){
        ...
        debug('load URL ', path.join( props.currPage ) + ' ' + opts.itemSelector);
    ...
    function loadCallback(){
        ...
        if (props.isDone){ 
            ...
            debug('contentSelector: ',opts.contentSelector);
